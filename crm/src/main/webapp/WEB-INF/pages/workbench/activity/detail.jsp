...
<script type="text/javascript">
	...
	$(function(){
		...
		//上面的方法会导致新追加的备注无法显示“修改”和“删除”的图标
			...
			$.ajax({
				...
				success:function (data) {
					if (data.code == "1") { //成功
						...
						htmlStr += "<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${requestScope.activity.name}</b> <small style=\"color: gray;\"> "+data.retData.createTime+" 由 ${sessionScope.sessionUser.name} 创建</small>";

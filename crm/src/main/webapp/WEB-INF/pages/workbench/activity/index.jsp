...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".myDate").datetimepicker({
			...
			autoclose:true,//设置选择完日期后自动关闭日历
			todayBtn:true,//设置显示“今天”按钮
			clearBtn:true//设置显示“清空”按钮
		});
		...
		$("#queryActivityBtn").click(function () {
			...
			query_startDate = $("#query-startDate").val();
			query_endDate = $("#query-endDate").val();
		...
		$("#exportActivityXzBtn").click(function () {
			...
			//获取id
			var ids = "";
			$.each(checkIds,function () {//id=xxx&id=xxx&...&id=xxx&
				ids += "id=" + this.value + "&";
			});
			ids = ids.substr(0,ids.length-1);//id=xxx&id=xxx&...&id=xxx

			//发送同步请求
			window.location.href="workbench/activity/exportSelectiveActivity.do?"+ids;
		});
		...
		$("#importActivityBtn").click(function () {
			...
			$.ajax({
				...
				data:formData,//该参数是一个文件
				processData:false,//设置ajax向后台提交参数之前，是否把参数统一转换为字符串
	...
	function queryActivityByConditionForPage(pageNo,pageSize) {
		...
		//发送请求
		$.ajax({
			url:'workbench/acticity/queryActivityByConditionForPage.do',
			data:{
				name:query_name,
				owner:query_owner,
			...
			success:function (data) {
				...
				$("#demo_page1").bs_pagination({
					...
					showGoToPage:true,//是否显示“跳转到”，默认true
					showRowsPerPage:true,//是否显示“每页显示条数”，默认true
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				...
				<div class="btn-group" style="position: relative; top: 18%;">
                    <button id="importActivity" type="button" class="btn btn-default"><span class="glyphicon glyphicon-import"></span> 上传列表数据（导入）</button>
